...
int main()
{
    ...
    auto explicitReturn = [](double a, double b) -> int {
        return a + b;
    };
    std::cout << "The sum from explicitReturn: " << explicitReturn(1.5, 3.5) << std::endl;

    std::cout << "Message: " << [](){ return (true) ? "bla" : "blabla"; }() << std::endl;
