...
int main()
{
    ...
    p_address1 = &address2; // this will cause a memory leaks. 
                            // because p_address1 is still in the memory but we points the p_address1 to address2
                            // we lost the access of the address 1;
    ...
    p_address3 = new int{123}; // we lost access to int{155}. memory with int{155} leaked.
